...
public class MinWindows {
	...
	public static void main(String[] args) {
		...
		String s1 = "";

		// bciiiaa
		//String s = "acaiaiaggca";
		//String s1 = "aac";
		System.out.println(minWindow(s, s1));
